...
public class DetailFragment extends Fragment implements DetailPresenterContract.View {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if ((arguments != null) && (arguments.containsKey(getString(R.string.BUNDLE_RECIPE_DATA)))) {
            mRecipe = arguments.getParcelable(getString(R.string.BUNDLE_RECIPE_DATA));
        }

        if(savedInstanceState != null && savedInstanceState.containsKey(getString(R.string.INSTANCE_KEY_ADAPTER_POSITION))) {
            mStepAdapterSavedPosition = savedInstanceState.getInt(getString(R.string.INSTANCE_KEY_ADAPTER_POSITION));
        }

        if(savedInstanceState != null) {
            if(savedInstanceState.containsKey(getString(R.string.INSTANCE_KEY_RECIPE))) {
                mRecipe = savedInstanceState.getParcelable(getString(R.string.INSTANCE_KEY_RECIPE));
            }

            if(savedInstanceState.containsKey(getString(R.string.INSTANCE_KEY_STEPS))) {
                mStepList = savedInstanceState.getParcelableArrayList(getString(R.string.INSTANCE_KEY_STEPS));
            }

            if(savedInstanceState.containsKey(getString(R.string.INSTANCE_KEY_INGREDIENTS_COUNT))) {
                int ingredientCount = savedInstanceState.getInt(getString(R.string.INSTANCE_KEY_INGREDIENTS_COUNT));
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putInt(getString(R.string.INSTANCE_KEY_ADAPTER_POSITION), mStepAdapter.getStepAdapterCurrentPosition());
        outState.putParcelable(getString(R.string.INSTANCE_KEY_RECIPE), mRecipe);
        outState.putParcelableArrayList(getString(R.string.INSTANCE_KEY_STEPS), mStepList);
        outState.putInt(getString(R.string.INSTANCE_KEY_INGREDIENTS_COUNT), mIngredientList.size());
    }
}
