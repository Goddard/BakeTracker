...
import com.goddardlabs.baketracker.databinding.StepListItemBinding;
...
public class StepAdapter extends RecyclerView.Adapter<StepAdapter.StepHolder> {
    ...
    public StepAdapter(ArrayList<Step> incomingStepSet, OnItemClickListener<Step> StepOnItemClickListener) {
    ...
    @Override
    public int getItemCount() { return (mStepList == null) ? 0 : mStepList.size(); }
